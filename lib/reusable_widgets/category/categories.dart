            ...
            itemBuilder: (context, i) {
              return Consumer<AdsProvider>(builder: (context, ads, childs) {
                ...
                return Padding(
                  padding: EdgeInsets.all(7.0),
                  child: CategoryCard(
                    title: categories[i-1]['category_name'],
                    imageUrl: categories[i-1]['image'],
                    isSelected: ads.currentCatg == categories[i-1]['category_name'],
                    onTap: () {
                      Provider.of<AdsProvider>(context, listen: false).updateCatg(categories[i-1]['category_name']);
                    },
                  ),
                );
              });
