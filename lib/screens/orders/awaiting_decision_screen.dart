...
class AwaitingDecisionScreen extends StatefulWidget {
  const AwaitingDecisionScreen({Key? key}) : super(key: key);

  @override
  State<AwaitingDecisionScreen> createState() => _AwaitingDecisionScreenState();
}

class _AwaitingDecisionScreenState extends State<AwaitingDecisionScreen> {
  bool isLoading = true;
  ...
  void _loadData() {
    final Map<String, dynamic> filterInfo = {
      'filterType': 'awaitingCustomer',
      'filterData': {},
      'offSet': 0,
    };
    Provider.of<OrderProvider>(context, listen: false).updateFilterInfo(filterInfo);
    Provider.of<OrderProvider>(context, listen: false).updateOrderStage(OrderStages.awaitingCustomer);
                  ...
                  children: [
                    ...
                    LimitedBox(
                      ...
                      child: OrdersTab(
                        ...
                        stage: OrderStages.awaitingCustomer,
                      ),
                    ),
                  ],
                ),
