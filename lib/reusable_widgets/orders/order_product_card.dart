...
class _OrderProductCardState extends State<OrderProductCard> {
  ...
  Widget build(BuildContext context) {
    return ModalProgressHUD(
      ...
      child: BlocListener<OrdersBloc, OrderState>(
          ...
          child: Column(
            children: [
                    ...
                    CylindricalButton(
                      ...
                      onDelete: () {
                        ...
                        orderBloc.add(DeleteOrderItemEvent(
                            orderId: widget.product['id'], token: jWTToken));
                      },
                      onAdd: () {
                        setState(() {
                          ++quantity;
              ...
              Row(
                ...
                children: [
                  Text(
                    widget.product['supplier']['businessName'],
                ...
                children: [
                  ...
                  OutlinedIconWidget(
                    onTap: () async {
                      ...
                      if (onPhone) {
                        String mobile = widget.product['supplier']['mobile'];
                  ...
                  if (onPhone)
                    Expanded(
                      child: Text(
                        widget.product['supplier']['mobile'],
                  ...
                  if (onLocation && !widget.onNotOrderStage)
                    Expanded(
                      child: Text(
                        widget.product['supplier']['address'],
                        overflow: TextOverflow.ellipsis,
                        style: kProductNameStylePro,
                        maxLines: 3,
                      ),
