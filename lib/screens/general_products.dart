...
class GeneralProducts extends StatefulWidget {
  static String path = '/generalproducts';
  const GeneralProducts({Key? key}) : super(key: key);

  @override
  _GeneralProductsState createState() => _GeneralProductsState();
}

class _GeneralProductsState extends State<GeneralProducts> {
                                          ...
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) => NewProduct(
                                                ...
                                                info: productsList[i],
                                                routeName: GeneralProducts.path,
                                              ),
                                            ),
                                          );
                                        },
